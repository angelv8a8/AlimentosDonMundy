...
/*  {  name: 'Apio' , imgUrl:  base + 'apio-stick.png',},
  ...
  {  name: 'Cilantro' , imgUrl: base + 'cilantro-lavado.png'},
  {  name: 'Ensaladas' , imgUrl: base + 'ensalada-premium.png'},
  {  name: 'Espinaca' , imgUrl: base + 'espinaca-lavada.png'},
  {  name: 'Lechuga Iceberg' , imgUrl: base + 'iceberg-entera.png'},
  {  name: 'Escarola Morada' , imgUrl: base + 'escarola-entera.png'},
  {  name: 'Escarola Verde' , imgUrl: base + 'escarola-verde-entera.png'},
  {  name: 'Romana' , imgUrl: base + 'romana-entera.png'},
  {  name: 'Perejil' , imgUrl: base + 'perejil-lavado.png'},
  {  name: 'Puerro' , imgUrl: base + 'puerro.png'},
  {  name: 'Tomate Manzano' , imgUrl: base + 'tomate-manzano-lavado.png'},
  {  name: 'Tomate Cocina' , imgUrl: base + 'tomate-cocina-lavado.png'},
